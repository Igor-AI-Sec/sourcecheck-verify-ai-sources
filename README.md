...
This is the tool behind the write-up ["I built a plugin to check whether AI makes up links. It went obsolete before I finished it"](#) — see the `/data` folder for the raw test results discussed there.
